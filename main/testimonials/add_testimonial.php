                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form class="needs-validation" novalidate
                                        action="../../components/add_testimonial_handler.php" enctype="multipart/form-data"
                                        method="POST">
                                        <div class="form-row">
                                            ...
                                            <div class="mb-3 col-12">
                                                ...
                                                <input type="text" class="form-control" id="validationCustom03"
                                                    name="commentor" placeholder="Commentor" required>
                                            ...
                                            <div class="mb-3 col-12">
                                                ...
                                                <textarea class="form-control" id="validationCustom06"
                                                    name="comment" placeholder="Enter comment here..." rows="5"
                                                    required></textarea>
                                                <div class="invalid-feedback">
